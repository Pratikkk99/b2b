...
import { ArrowRight, Activity, Shield, Users, ChevronRight, Calendar, TrendingUp, Heart, Zap } from 'lucide-react';
...
export const LandingPage: React.FC<LandingPageProps> = ({ onLoginClick }) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-orange-50 font-sans text-slate-900 selection:bg-brand-orange selection:text-white overflow-x-hidden">
      ...
      <nav className="fixed w-full z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 hover:scale-105 transition-transform duration-300 cursor-pointer">
             ...
             <span className="text-xl font-extrabold tracking-tight text-brand-blue hidden md:block">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center z-10">
          ...
          <div className="space-y-8 text-center lg:text-left animate-fade-in-up">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-brand-blue/10 text-brand-blue rounded-full text-sm font-bold shadow-sm hover:shadow-md transition-all cursor-default">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-[1.1] text-brand-dark">
              Forge Your <br/>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <button className="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 rounded-2xl font-bold border border-slate-200 hover:border-brand-orange hover:text-brand-orange transition-all flex items-center justify-center gap-2 group shadow-sm">
            ...
            <div className="pt-8 flex items-center justify-center lg:justify-start gap-8 text-slate-500 border-t border-slate-200 mt-4">
               <div className="text-center lg:text-left">
                   <p className="text-3xl font-black text-brand-dark">15k+</p>
                   <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Active Members</p>
               </div>
               <div className="h-10 w-px bg-slate-200"></div>
               <div className="text-center lg:text-left">
                   <p className="text-3xl font-black text-brand-dark">500+</p>
                   <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Certified Pros</p>
               </div>
               <div className="h-10 w-px bg-slate-200"></div>
               <div className="text-center lg:text-left">
                   <p className="text-3xl font-black text-brand-dark">98%</p>
          ...
          <div className="relative animate-fade-in hidden lg:block">
             <div className="absolute inset-0 bg-gradient-to-tr from-brand-blue/10 to-brand-pink/10 rounded-[3rem] blur-3xl transform rotate-6 animate-pulse-slow"></div>
             
             {/* Main App Preview Card */}
             <div className="relative bg-white border border-slate-100 rounded-[2.5rem] p-4 shadow-2xl transform rotate-[-2deg] hover:rotate-0 transition-all duration-500 group">
                 <div className="relative overflow-hidden rounded-[2rem] shadow-inner bg-slate-50 aspect-[4/3]">
                     <img 
                 ...
                 <div className="absolute -top-6 -right-6 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-4 animate-float z-20">
                    <div className="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center text-red-500">
                       <Heart size={24} fill="currentColor"/>
                    </div>
                    <div>
                       <p className="text-xs text-slate-500 font-bold uppercase">Heart Rate</p>
                       <p className="text-xl font-black text-slate-900">128 <span className="text-sm font-normal text-slate-400">bpm</span></p>
                    </div>
                 </div>

                 {/* Floating Element 2: Calories */}
                 <div className="absolute -bottom-10 -left-6 bg-white p-5 rounded-2xl shadow-xl border border-slate-100 flex flex-col gap-2 animate-float z-20" style={{animationDelay: '1s'}}>
      ...
      <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6">
              <div className="text-center mb-16">
                  <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4">The Trinity of Fitness</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {/* Strength */}
                  <div className="group relative overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 p-8 hover:shadow-2xl transition-all duration-300">
                  ...
                  <div className="group relative overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 p-8 hover:shadow-2xl transition-all duration-300">
                      ...
                      <h3 className="text-2xl font-bold text-slate-900 mb-4">Endurance</h3>
                      <p className="text-slate-500 mb-6 leading-relaxed">
                  ...
                  <div className="group relative overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 p-8 hover:shadow-2xl transition-all duration-300">
                      ...
                      <h3 className="text-2xl font-bold text-slate-900 mb-4">Flexibility</h3>
                      <p className="text-slate-500 mb-6 leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col md:flex-row items-center justify-between gap-16">
                  <div className="flex-1 space-y-8">
                      <h2 className="text-3xl md:text-4xl font-black text-slate-900">Your Path to Glory</h2>
                      <div className="space-y-6">
                          {[
                              ...
                              <div key={idx} className="flex gap-4 items-start">
                                  <div className="text-2xl font-black text-slate-300">{item.step}</div>
                                  <div>
                  ...
                  <div className="flex-1 relative">
                       ...
                       <GlassCard className="relative z-10 transform rotate-3 hover:rotate-0 transition-all duration-500 border-2 border-white/50">
                            <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-4">
                                <div>
                                    <p className="text-xs text-slate-500 uppercase font-bold">Weekly Progress</p>
                                    <h3 className="text-2xl font-black text-slate-900">On Track</h3>
                                </div>
      ...
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
                ...
                <div key={idx} className="group p-8 rounded-3xl border border-slate-100 bg-slate-50 hover:bg-white hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300">
